...
createServer({
  ...
  routes() {
    //this.namespace = "api";
    this.passthrough('http://localhost:4000/stats/new-dashboard'); 
    authServerConfig(this);
    ShopServerConfig(this);
    calendarServerConfig(this);
    this.timing = 500;
    this.passthrough('https://influencers-o6yr.onrender.com/stats/new-dashboard');
    this.passthrough('https://influencers-o6yr.onrender.com/stats/most-like');
